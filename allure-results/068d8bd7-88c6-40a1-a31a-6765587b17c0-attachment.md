...
```
Error: page.goto: net::ERR_NAME_NOT_RESOLVED at https://praywrightdev.com/
Call log:
  - navigating to "https://praywrightdev.com/", waiting until "load"
...
- paragraph: Check if there is a typo in praywrightdev.com.
- paragraph
- list:
  - listitem:
...
```ts
   ...
   5 | {
>  6 | await page.goto('https://praywrightdev.com');
     |            ^ Error: page.goto: net::ERR_NAME_NOT_RESOLVED at https://praywrightdev.com/
